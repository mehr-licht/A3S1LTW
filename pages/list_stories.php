...
<body>
    <section id="stories">
        ...
        <article class="post preview" --data-id-post="<?= $post['idPost'] ?>">
            <aside class="votes">
                <svg class="votes upvote <?= ($vote > 0) ? 'active' : '' ?>" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="444.819px" height="444.819px" viewBox="0 0 444.819 444.819">
                    <g>
                        <!-- up arrow svg -->
                ...
                <span>
                    <?=isset($post['points']) ? $post['points'] : 0 ?></span>
                <svg class="votes downvote <?= ($vote < 0) ? 'active' : '' ?>" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" width="444.819px" height="444.819px" viewBox="0 0 444.819 444.819">
                    <g>
                        <!-- down arrow svg -->
            ...
            <div class="content">
                ...
                <div>
                    <span>
                        ...
                        <span class="rating">•
                            <?= processingGetPoints($post['idUser'])?> points</span>
...
$thumbsURL = $imagePath . '/thumb_' . $imageName;
                                    ...
                                    ?>
                        <a href="<?=$post['image']?>"> <img class="thumb" <?php if(file_exists($thumbsURL)) { ?> src="
                            <?=$thumbsURL?>"
                            <?php
        }else{
            ?> src="
